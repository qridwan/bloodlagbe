    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 items-end">
      ...
      {/* <button
        onClick={() => onFilterChange({
          bloodGroup: '', campusId: '', groupId: '', city: '', district: '', availability: ''
        })}
        disabled={isLoading}
        className="mt-1 py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-500 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400"
      >
        Clear Filters
      </button> */}
    </div>
