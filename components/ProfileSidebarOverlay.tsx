...
export default function ProfileSidebarOverlay({ isOpen, onClose, items }: Props) {
	...
	return (
		...
		>
			<div
				className={`fixed top-0 left-0 h-full w-64 bg-slate-900 text-white p-5 shadow-lg transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'
					}`}
			>
