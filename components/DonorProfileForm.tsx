			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<div>
					<label htmlFor="campusId" className="block text-sm font-medium text-gray-700">
						Campus / Institution <span className="text-xs text-grey-500 bg-green-200 p-[1px] rounded-md">(optional)</span>
				...
				<div>
					<label htmlFor="groupId" className="block text-sm font-medium text-gray-700">
						Social Group / Organization <span className="text-xs text-grey-500 bg-green-200 p-[1px] rounded-md">(optional)</span>
					</label>
					<select
						name="groupId"
						id="groupId"
