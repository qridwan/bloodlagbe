...
export async function GET(request: Request) {
  ...
  if (city) {
    where.city = { contains: city, mode: 'insensitive' }; // Case-insensitive search for city
  }
  if (district) {
    where.district = { contains: district, mode: 'insensitive' }; // Case-insensitive search for district
  }
