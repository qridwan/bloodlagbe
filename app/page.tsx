      ...
      <section className="text-center py-12 md:py-20 bg-gradient-to-br from-red-50 via-rose-50 to-pink-50 rounded-lg shadow-xl">
        <div className="container mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-red-700 mb-6 leading-tight">
            Be a Lifesaver, <br />{' '}
            <span className="block md:inline pt-2">Connect Through BloodLagbe.</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto mb-10">
            BloodLagbe is a dedicated platform connecting voluntary blood donors with those in
            urgent need. Join our community to find blood or register as a donor and make a
            difference.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12 text-center">
            <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
              ...
              <p className="text-gray-600 text-sm">
                Quickly find donors by blood group, location, campus, and more with our intuitive
                filters.
              </p>
            </div>
            <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
      ...
      <section className="py-12 md:py-20 bg-rose-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto mb-8">
            Whether you need blood or want to donate, BloodLagbe is here to help. Join our growing
            community today.
          </p>
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Link
